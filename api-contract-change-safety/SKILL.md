...
description: Use when planning or implementing a requested change to externally observable API behavior that may require coordinated updates to schemas, clients, permissions, or documentation.
---
...
4. When implementation is requested, update affected implementation, schemas, generated artifacts, tests, and documentation together. For advisory or planning tasks, explain the coordinated update set without editing files. Preserve existing conventions unless the authorized change explicitly changes them.
